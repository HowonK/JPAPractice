...
class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        person.setName("회원1");
        person.setAddress(new Address("서울", "강가", "123-123"));
        em.persist(person);
        ...
        int orderCount = 2;
        //when
        Long orderId = orderService.order(person.getId(), book.getId(), orderCount);
    ...
    public void 상품주문_재고수량초과() throws Exception {
        ...
        //when
        try {
            orderService.order(person.getId(), book.getId(), orderCount);
